  ...
  <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="text-center">
      ...
      <div class="mt-3 space-x-2">
        <a class="inline-flex items-center justify-center w-10 h-10 text-center text-gray-500 transition rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
          href="#">
