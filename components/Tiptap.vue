  ...
  <div v-if="editor" class="flex flex-col w-full h-full rounded-none sm:rounded-lg">
    <div class="sticky top-0 z-20 flex justify-between border-b text-neutral-500 focus:outline-none toolbar ">
      <div class="flex flex-wrap items-center gap-3 p-2 sm:p-4 text-stone-400 ">
        ...
        <!-- image -->
        <label class="flex flex-col items-center transition-colors cursor-pointer "
          ...
          <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            :class="[editor.isActive('image') ? 'is-active text-teal-600' : ' hover:text-teal-500 w-6 h-6']">
            <path
        ...
        <!-- undo-->
        <button @click.prevent="editor.chain().focus().undo().run()" class="hover:text-teal-500">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
        ...
        <!-- redo-->
        <button @click.prevent="editor.chain().focus().redo().run()" class="hover:text-teal-500">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
